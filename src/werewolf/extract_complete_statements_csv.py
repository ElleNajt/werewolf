#!/usr/bin/env python3
"""
Extract complete werewolf and villager statements with probe scores to CSV.
...
def main():
    ...
    werewolf_file = output_dir / "70b_werewolf_complete_statements.csv"
    villager_file = output_dir / "70b_villager_complete_statements.csv"
