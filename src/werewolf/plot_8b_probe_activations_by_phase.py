#!/usr/bin/env python3
"""
Plot 8B probe activation patterns across different stages, with Action split by phase.
Same style as 70B version but for 8B model data.
"""
...
def plot_activation_histograms(data, output_file: str):
    ...
    plt.suptitle('8B Probe Activations Across Stages (Action Split by Phase)', 
...
def main():
    print("\n" + "="*80)
    print("8B PROBE ACTIVATION ANALYSIS (SPLIT BY PHASE)")
    print("="*80)
    
    # Load data from the 8B probe directory
    probe_dir = Path("../../results/final_8b_probe_simple_d79edc0_8288738")
    ...
    plot_activation_histograms(data, "../../results/8b_probe_activations_by_phase.png")
    
    print("\n" + "="*80)
    print("ANALYSIS COMPLETE")
    print("="*80)
    print("\nGenerated file:")
    print("  - results/8b_probe_activations_by_phase.png")
    print("="*80)
