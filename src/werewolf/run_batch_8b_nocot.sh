#!/bin/bash
# Batch experiment: Llama 8B, 2v4, NO CoT, WITH probe scores, 10 games

EXPERIMENT_NAME="experiment_8b_nocot_2v4"
CONFIG_FILE="config.8b_no_cot.json"
NUM_GAMES=10

echo "Starting batch experiment: $NUM_GAMES games with Llama 8B (NO CoT, WITH probe scores, 2v4)"
